...
class BarangayDistanceSeeder extends Seeder
{
    ...
    /**
     * Map flat index (0..totalPairs-1) to pair (i,j) for combinations i < j
     * This uses the same ordering used by the generator (outer loop i from 0..n-1, inner j from i+1..n-1)
     */
